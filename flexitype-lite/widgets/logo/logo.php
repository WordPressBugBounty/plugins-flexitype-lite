...
class FlexiType_Logo extends Widget_Base
{

    public function get_name()
    {
        return 'flexitype-logo';
    }

    public function get_title()
    {
        return esc_html__('Logo','flexitype-lite');
    }

    public function get_icon()
    {
        return 'flexitype-icon eicon-logo';
    }
    ...
    {
        return ['logo', 'header', 'theme', 'elements', 'site'];
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'logo_img',
            [
                'label' => esc_html__('Logo','flexitype-lite'),
            ]
        );
        $this->add_control(
            'image',
            [
                'label' => esc_html__('Choose logo','flexitype-lite'),
        ...
        $this->add_control(
            'link',
            [
                'label' => esc_html__('Link','flexitype-lite'),
                'type' => Controls_Manager::URL,
                'placeholder' => esc_html__('https://your-link.com','flexitype-lite'),
            ]
        );
        ...
        $this->start_controls_section(
            'logo_style_img',
            [
                'label' => esc_html__('Logo Style','flexitype-lite'),
...
Plugin::instance()->widgets_manager->register(new FlexiType_Logo);